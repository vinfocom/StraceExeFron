...
export const COLORS = {
  ...
  STAT_CARD: {
    blue: "bg-blue-500/10 text-white  border-blue-500/20",
    green: "bg-green-500/10 text-white border-green-500/20",
    purple: "bg-purple-500/10 text-white border-purple-500/20",
    orange: "bg-orange-500/10 text-white  border-orange-500/20",
    red: "bg-red-500/10 text-red-500 text-white border-red-500/20",
    yellow: "bg-yellow-500/10 text-white border-yellow-500/20",
    cyan: "bg-cyan-500/10 text-white border-cyan-500/20",
  }
};
