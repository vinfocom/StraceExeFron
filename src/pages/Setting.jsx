...
const PARAMETERS = {
    ...
    mac_dl: "MAC DL",
    mac_dl_delivered: "MAC DL Delivered",
    mac_ul: "MAC UL",
    mac_ul_delivered: "MAC UL Delivered",
    mac_bler: "MAC BLER",
    mac_bler_init: "MAC BLER Init",
    mac_mcs: "MAC MCS",
    mac_retx: "MAC Retx",
    mac_rb: "MAC RB",
    mac_grants: "MAC Grants/Sec",
...
const buildSavePayload = (thresholds, userId) => {
    ...
    const payload = { 
        ...
        mac_dl_json: normalizeBucketedRanges("mac_dl", thresholds.mac_dl),
        mac_dl_delivered_json: normalizeBucketedRanges("mac_dl_delivered", thresholds.mac_dl_delivered),
        mac_ul_json: normalizeBucketedRanges("mac_ul", thresholds.mac_ul),
        mac_ul_delivered_json: normalizeBucketedRanges("mac_ul_delivered", thresholds.mac_ul_delivered),
        mac_bler_json: normalizeBucketedRanges("mac_bler", thresholds.mac_bler),
        mac_bler_init_json: normalizeBucketedRanges("mac_bler_init", thresholds.mac_bler_init),
        mac_mcs_json: normalizeBucketedRanges("mac_mcs", thresholds.mac_mcs),
        mac_retx_json: normalizeBucketedRanges("mac_retx", thresholds.mac_retx),
        mac_rb_json: normalizeBucketedRanges("mac_rb", thresholds.mac_rb),
        mac_grants_json: normalizeBucketedRanges("mac_grants", thresholds.mac_grants),
        mac_tx_power_json: normalizeBucketedRanges("mac_tx_power", thresholds.mac_tx_power),
        mac_modulation_pct_json: normalizeBucketedRanges("mac_modulation_pct", thresholds.mac_modulation_pct),
